...
public class CarteAuxTresors
{
    ...
    {
    	AppConsoleOneRun consoleApp = null;
    	...
    	if ( inputfileName == null || inputfileName.isEmpty()) {
    		...
    		serviceConfig =
    			new InteractiveConsoleConfigurationProvider(System.in, 
    														System.out);	
    	// input in file
    	} else {
    		...
    		serviceConfig = new FileConfigurationProvider(fr);
    	}
    	...
    	consoleApp = new AppConsoleOneRun(controller);
